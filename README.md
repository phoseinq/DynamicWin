...
- 🔔 **Notifications** — every toast is mirrored into the pill with the real app icon. Click to open it, or pull the grabber down to read a long message in full.
...
> [!NOTE]
> Halo is a from-scratch rewrite of [DynamicWin](https://github.com/FlorianButz/DynamicWin) by Florian Butz — no upstream code. Built with .NET 9; `installer/build.ps1` produces the signed setup + portable zip.
