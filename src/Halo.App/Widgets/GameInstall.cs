// GameInstall.cs — Tracks GDK game installs (Roblox and the like) by watching their on-disk staging folder, since they are invisible to the normal install APIs.
