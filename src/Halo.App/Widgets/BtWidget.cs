// BtWidget.cs — Transient collapsed-pill display shown when a Bluetooth device connects: a device-type icon wrapped in a battery ring (green when full, red when low) with the percentage beside it.
