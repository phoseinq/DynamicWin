// MediaWidget.cs — Now Playing via the system media transport controls (Spotify, browsers, players): album or animated-GIF art, a live waveform, and transport that adapts to what each app actually supports.
