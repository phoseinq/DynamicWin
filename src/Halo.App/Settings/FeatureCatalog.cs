...
// The things a user can switch off. One entry per widget family the pill can show, which is what makes
// the panel's feature pages and the pill's own widget list two views of one list rather than two lists
...
{
    // Key is the wire name and never changes once shipped - it is what sits in settings.json. Label and
    // description are display text and may.
