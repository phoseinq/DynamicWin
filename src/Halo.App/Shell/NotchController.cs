// NotchController.cs — Core controller of the pill: the per-frame update loop, widget selection, notification banners, drag / resize / pin, and system alerts (battery, CPU, Bluetooth, hourly chime).
