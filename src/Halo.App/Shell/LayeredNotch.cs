// LayeredNotch.cs — The layered, per-pixel window. Composites the pill and its swap-circle strip with real acrylic glass, and hosts the OLE drop target used by the File Tray.
