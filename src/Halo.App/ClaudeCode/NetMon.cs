// NetMon.cs — Two-path connectivity monitor for Claude Code: your internet (google.com/generate_204) and the Anthropic API, feeding the panel's connection graph and the "bad internet" banner.
